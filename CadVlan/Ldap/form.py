...
class UserForm(forms.Form):
    ...
    groupPattern = forms.ChoiceField(
        label=u'Grupo Padrão:',
        required=True,
    ...
    userType = forms.ChoiceField(
        label=u'Tipo de Usuário:',
        required=False,
        choices=CHOICES_USER_TYPE,
        initial=CHOICES_USER_TYPE[0][0],
        error_messages=error_messages,
        widget=forms.RadioSelect(
            renderer=RadioCustomRenderer))

    cn = forms.CharField(
        label=u'Username (UID / CN):',
        max_length=50,
        required=True,
        validators=[validate_cn],
        error_messages=error_messages,
    ...
    uidNumber = forms.IntegerField(
        ...
        widget=forms.TextInput(
            attrs={
                'style': "width: 300px"}))
    homeDirectory = forms.CharField(
        label=u'homeDirectory:',
        max_length=50,
        required=False,
        error_messages=error_messages,
        widget=forms.TextInput(
