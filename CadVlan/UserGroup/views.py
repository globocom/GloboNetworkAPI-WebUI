...
def load_list(request, lists, id_ugroup, tab):
    ...
    try:
        ...
        lists['users'] = validates_dict(
            client.create_usuario().list_by_group(id_ugroup),
            'users')
...
@has_perm([{"permission": ADMINISTRATION, "read": True},
           {"permission": ADMINISTRATION, "write": True}])
        ...
        if form.is_valid():
            ...
            # If all has ben removed
                ...
                messages.add_message(
                    request,
                    messages.SUCCESS,
                    user_group_messages.get("success_remove"))
            ...
            if form.is_valid():
                ...
                try:
                    ...
                    messages.add_message(
                        request,
                        messages.SUCCESS,
                        user_group_messages.get("success_insert"))
        ...
        if form.is_valid():
            ...
            # If all has ben removed
                ...
                messages.add_message(
                    request,
                    messages.SUCCESS,
                    perm_group_messages.get("success_remove"))
...
def add_form_perm(request, id_ugroup):
    ...
    try:
        ...
        function_list = validates_dict(
            auth.get_clientFactory().create_permission().list_all(),
            'perms')
        ...
        if request.method == "POST":
            ...
            if form.is_valid():
                ...
                messages.add_message(
                    request,
                    messages.SUCCESS,
                    perm_group_messages.get("success_insert"))
...
def edit_form_perm(request, id_ugroup, id_perm):
    ...
    try:
        ...
        if request.method == "POST":
            ...
            if form.is_valid():
                ...
                messages.add_message(
                    request,
                    messages.SUCCESS,
                    perm_group_messages.get("success_edit"))
        ...
        # GET
            ...
            initial = {
                "id_group_perms": perm.get("id"),
                "function": perm.get("permission"),
                "read": convert_string_to_boolean(
                    perm.get("leitura")),
                "write": convert_string_to_boolean(
                    perm.get("escrita"))}
