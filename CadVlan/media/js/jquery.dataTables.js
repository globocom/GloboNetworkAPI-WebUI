	...
	var DataTable = function( oInit )
	{
		...
		function _fnAjaxParameters( oSettings )
		{
			...
			for (i = 0; i < aoData.length; i++) {
				objList[aoData[i].name] = aoData[i].value;
			}
			return objList;
		}
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			...
			"oAria": {
				 ...
				 *    } );
				 */
				"sSortAscending": ": clique para ordenar do menor para o maior.",
				 ...
				 *    } );
				 */
				"sSortDescending": ": clique para ordenar do maior para o menor."
			},
			 ...
			 *    } );
			 */
			"sInfo": "Exibindo de _START_ até _END_. Total: _TOTAL_",
...
$.fn.dataTableExt.oApi.fnAjaxUpdate = function ( oSettings )
{
	this.oApi._fnPageChange ( oSettings, "first" )
