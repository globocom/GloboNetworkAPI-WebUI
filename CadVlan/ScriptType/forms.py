...
class ScriptTypeForm(forms.Form):
    ...
    script_type = forms.CharField  (label=u'Tipo de Roteiro', min_length=3, max_length=40 , required=True, error_messages=error_messages, widget=forms.TextInput(attrs={'style': "width: 300px"}))
