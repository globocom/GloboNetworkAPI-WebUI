    ...
    try:
        ...
        try:
            ...
            messages.add_message(
                request, messages.ERROR, user_messages.get("ldap_offline"))
            ldap_up = False
            ldap_groups_ = None
            ldap_groups = None
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                if edit:
                    ...
                    messages.add_message(
                        request, messages.SUCCESS, user_messages.get("success_edit"))

                else:

                    save_user(form, client)
                    messages.add_message(
                        request, messages.SUCCESS, user_messages.get("success_insert"))
...
def edit_user(form, client, id_user):
    ...
    client.create_usuario().alterar(
        id_user, user.upper(), pwd, name, ativo, email, user_ldap)
