...
urlpatterns += patterns('CadVlan.ScriptType.views',
                        url('^script-type/list[/]?$',
                            'list_all',
                            name='script.type.list',
                            ),
                        url('^script-type/delete[/]?$',
                            'delete_all',
                            name='script.type.delete',
                            ),
                        url('^script-type/form[/]?$',
                            'show_form',
                            name='script.type.form',
                            ))
...
urlpatterns += patterns('CadVlan.Environment.views',
                        ...
                        url('^environment/ambiente-logico[/]?$',
                            'insert_ambiente_logico',
                            name='environment.insert.ambiente.logico',
                            ),
                        url('^environment/grupo-l3[/]?$',
                            'insert_grupo_l3',
                            name='environment.insert.grupo.l3',
                            ),
                        url('^environment/divisao-dc[/]?$',
                            'insert_divisao_dc',
                        ...
                        url('^environment/acl_paths[/]$',
                            'ajax_autocomplete_acl_path',
                            name='acl_path.autocomplete',
                            ),
                        url('^environment/configuration/form/(?P<id_environment>\d+)[/]?$',
                            'add_configuration',
                            name='environment.configuration.add',
                            ),
...
urlpatterns += patterns('CadVlan.Vlan.views',
                        url('^vlan/autocomplete[/]?$',
                            'ajax_autocomplete_vlans',
                            name='vlan.autocomplete.ajax',
                            ),
                        url('^vlan/get/(?P<id_vlan>\d+)[/]?$',
                            'list_by_id',
                            name='vlan.list.by.id',
                            ),
                        url('^vlan/list[/]?$',
                            'search_list',
                        ...
                        url('^vlan/aclfilename[/]?$',
                            'ajax_acl_name_suggest',
                            name='ajax.vlan.acl.file.name',
                            ),
                        url('^vlan/confirmvlan[/]?$',
                            'ajax_confirm_vlan',
                            name='ajax.vlan.confirm',
                            ),
                        url('^vlan/edit/(?P<id_vlan>\d+)[/]?$',
                            'vlan_edit',
                            name='vlan.edit.by.id',
                            ),
                        url('^vlan/delete[/]?$',
                            'delete_all',
                            name='vlan.delete',
                        ...
                        url('^vlan/create/network/(?P<id_vlan>\d+)[/]?$',
                            'create_network',
                            name='vlan.create.network'),
                        url('^vlan/form/get/available/environment/configuration/by/environment/id[/]?$',
                            'ajax_get_available_ip_config_by_environment_id',
                            name='vlan.get.available.environment.configuration'),
                        )
...
urlpatterns += patterns('CadVlan.OptionVip.views',
                        url('^option-vip/list[/]?$',
                            'list_all',
                            name='option-vip.list',
                            ),
                        url('^option-vip/delete[/]?$',
                            'delete_all',
                            name='option-vip.delete',
                            ),
                        url('^option-vip/form[/]?$',
                            'add_form',
                            name='option-vip.form',
                            ),
                        url('^option-vip/form/(?P<id_optionvip>\d+)[/]?$',
                            'edit_form',
                            name='option-vip.edit',
                            ),
                        url('^option-vip/associate4/(?P<id_net>\d+)[/]?$',
                            'option_vip_associate_net4',
                            name='option-vip.associate.net4',
                            ),
                        url('^option-vip/associate6/(?P<id_net>\d+)[/]?$',
                            'option_vip_associate_net6',
                            name='option-vip.associate.net6',
                            ),
                        )
...
urlpatterns += patterns('CadVlan.EnvironmentVip.views',
                        url('^environment-vip/list[/]?$',
                            'list_all',
                            name='environment-vip.list',
                            ),
                        url('^environment-vip/delete[/]?$',
                            'delete_all',
                            name='environment-vip.delete',
                            ),
                        url('^environment-vip/form[/]?$',
                            'add_form',
                            name='environment-vip.form',
                            ),
                        url('^environment-vip/form/(?P<id_environmentvip>\d+)[/]?$',
                            'edit_form',
                            name='environment-vip.edit',
                            ),
                        )
...
urlpatterns += patterns('CadVlan.User.views',
                        url(
                            '^user/list/(?P<id_user>\d+)/(?P<status>\d+)[/]?$',
                            'list_all',
                            name='user.list',
                        ),
                        url(
                            '^user/form/(?P<id_user>\d+)/(?P<status>\d+)[/]?$',
                            'list_all',
                            name='user.form',
                        ),
                        url(
                            '^user/edit/(?P<id_user>\d+)/(?P<status>\d+)[/]?$',
                            'list_all',
                            name='user.edit',
                        ),
                        url('^user/delete[/]?$',
                        ...
                        url(
                            'ldap/usersbygroup/(?P<ldap_group>[^/]+)/(?P<id_user>[^/]+)[/]',
                            'ajax_ldap_users_by_group',
                            name='ldap.userbygroup.ajax'),
                        url(
                            'ldap/pop_ldap_user_mail/(?P<cn>[^/]+)[/]',
                            'ajax_ldap_pop_name_mail',
                            name='ldap.pop_name_mail.ajax'),
...
urlpatterns += patterns('CadVlan.UserGroup.views',
                        url('^user-group/list/(?P<id_ugroup>\d+)/(?P<tab>\d+)[/]?$',
                            'list_all',
                        ...
                        url('^user-group-perm/form/(?P<id_ugroup>\d+)[/]?$',
                            'add_form_perm',
                            name='user-group-perm.form',
                            ),
                        url('^user-group-perm/form/(?P<id_ugroup>\d+)/(?P<id_perm>\d+)[/]?$',
                            'edit_form_perm',
                            name='user-group-perm.edit',
                            ),
                        url('^user-group-perm/delete/(?P<id_ugroup>\d+)[/]?$',
                            'delete_perm',
                            name='user-group-perm.delete',
                            ),
                        )

# URL's ACL
urlpatterns += patterns('CadVlan.Acl.views',
                        url('^acl/create/(?P<id_vlan>\d+)/(?P<network>v4|v6)[/]?$',
                            'create',
                            name='acl.create',
                            ),
                        url('^acl/remove/(?P<id_vlan>\d+)/(?P<network>v4|v6)[/]?$',
                            'remove',
                            name='acl.remove',
                            ),
                        url('^acl/edit/(?P<id_vlan>\d+)/(?P<network>v4|v6)[/]?$',
                            'edit',
                            name='acl.edit',
                            ),
                        url('^acl/script/(?P<id_vlan>\d+)/(?P<network>v4|v6)[/]?$',
                            'script',
                            name='acl.script',
                            ),
                        ...
                        url('^acl/template/add/[/]?$',
                            'template_add',
                            name='acl.template.add',
                            ),
                        url('^acl/template/edit/(?P<template_name>.+)/(?P<network>IPv4|IPv6)[/]?$',
                            'template_edit',
                            name='acl.template.edit',
                            ),
                        url('^acl/template/delete[/]?$',
                            'template_delete',
                            name='acl.template.delete',
                            ),
                        )
...
urlpatterns += patterns('CadVlan.HealthcheckExpect.views',
                        url('^healthcheck-expect/form[/]?$',
                            'healthcheck_expect_form',
                            name='healthcheck-expect.form',
                            ),
                        )
...
urlpatterns += patterns('CadVlan.BlockRules.views',
                        ...
                        url('^block/edit/(?P<id_env>\d+)[/]?$',
                            'edit_form',
                            name='block.edit.form',
                            ),
                        url('^rules/list/(?P<id_env>\d+)[/]?$',
                            'rules_list',
                            name='block.rules.list',
                            ),
                        url('^rules/form[/]?$',
                            'rule_form',
                            name='rule.form',
                        ...
                        url('^rules/form/(?P<id_env>\d+)[/]?$',
                            'rule_add_form',
                            name='block.rules.form',
                            ),
                        url('^rules/edit/(?P<id_env>\d+)/(?P<id_rule>\d+)[/]?$',
                            'rule_edit_form',
                            name='block.rules.edit',
                            ),
                        url('^rules/remove/(?P<id_env>\d+)[/]?$',
                            'rule_remove',
                            name='block.rules.remove',
                            ),
                        url('^block/ajax',
                            'block_ajax',
                            name='block.ajax',
