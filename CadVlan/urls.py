...
urlpatterns += patterns('CadVlan.Equipment.views',
    ...
    url('^equipment/autocomplete/external[/]?$', 'ajax_autocomplete_equips_external', name='equipment.autocomplete.ajax.external',),
...
urlpatterns += patterns('CadVlan.Environment.views',
    ...
    url('^environment/remove[/]?$', 'remove_environment', name='environment.remove',),
...
urlpatterns += patterns('CadVlan.VipRequest.views',
    ...
    url('^vip-request/form/external/(?P<id_vip>\d+)[/]?$', 'edit_form_external', name='vip-request.edit.external',),
    url('^vip-request/ajax_client/external[/]?$', 'ajax_popular_client_external', name='vip-request.client.ajax.external',),
    ...
    url('^vip-request/ajax_environment/external[/]?$', 'ajax_popular_environment_external', name='vip-request.environment.ajax.external',),
    url('^vip-request/ajax_options[/]?$', 'ajax_popular_options', name='vip-request.options.ajax',),
    url('^vip-request/ajax_options/external[/]?$', 'ajax_popular_options_external', name='vip-request.options.ajax.external',),
    url('^vip-request/ajax_add_healthcheck[/]?$', 'ajax_add_healthcheck', name='vip-request.add.healthcheck.ajax',),
    url('^vip-request/ajax_add_healthcheck/external[/]?$', 'ajax_add_healthcheck_external', name='vip-request.add.healthcheck.ajax.external',),
    url('^vip-request/ajax_modal_real_server[/]?$', 'ajax_model_ip_real_server', name='vip-request.modal.real.server.ajax',),
    url('^vip-request/ajax_modal_real_server/external[/]?$', 'ajax_model_ip_real_server_external', name='vip-request.modal.real.server.ajax.external',),
    url('^vip-request/operation/ajax/(?P<id_vip>\d+)/(?P<operation>\d+)[/]?$', 'ajax_validate_create_remove', name='vip.ajax.create.validate.remove',),
    url('^vip-request/tab/real-server/(?P<id_vip>\d+)[/]?$', 'tab_real_server', name='vip-request.tab.real.server',),
    url('^vip-request/tab/real-server/(?P<id_vip>\d+)/status[/]?$', 'tab_real_server_status', name='vip-request.tab.real.server.status.edit',),
...
urlpatterns += patterns('CadVlan.Ldap.views',
    ...
    url('^ldap/sudoer/list[/]?$', 'list_all_sudoer', name='ldap.sudoer.list',),
    url('^ldap/sudoer/form[/]?$', 'add_sudoer_form', name='ldap.sudoer.form',),
    url('^ldap/sudoer/form/(?P<cn>[^/]+)[/]?$', 'edit_sudoer_form', name='ldap.sudoer.edit',),
    url('^ldap/sudoer/delete[/]?$', 'delete_sudoer_all', name='ldap.sudoer.delete',),
    url('^ldap/user/list/(?P<pattern>interno|externo)[/]?$', 'list_all_user', name='ldap.user.list',),
    url('^ldap/user/form/(?P<pattern>interno|externo)[/]?$', 'add_user_form', name='ldap.user.form',),
    url('^ldap/user/form/(?P<cn>[^/]+)/(?P<pattern>interno|externo)[/]?$', 'edit_user_form', name='ldap.user.edit',),
    url('^ldap/user/delete/(?P<pattern>interno|externo)[/]?$', 'delete_user_all', name='ldap.user.delete',),
    url('^ldap/user/reset/password[/]?$', 'ajax_reset_password_user', name='ldap.user.reset.pwd.ajax',),
