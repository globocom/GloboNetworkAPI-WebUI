...
urlpatterns += patterns(
    ...
    url('^vlan/get/(?P<id_vlan>\d+)/(?P<sf_number>\d+)/(?P<sf_name>[\w\-\s]+)/(?P<sf_environment>\d+)/(?P<sf_nettype>\d+)/(?P<sf_subnet>\d+)/(?P<sf_ipversion>\d+)/(?P<sf_network>\w+)/(?P<sf_iexact>\d+)/(?P<sf_acl>\d+)[/]?$',
        'list_by_id', name='vlan.list.by.id',),
    url('^vlan/list[/]?$',
        'search_list', name='vlan.search.list',),
    url('^vlan/list/(?P<id_vlan>\d+)/(?P<sf_number>\d+)/(?P<sf_name>[\w\-\s]+)/(?P<sf_environment>\d+)/(?P<sf_nettype>\d+)/(?P<sf_subnet>\d+)/(?P<sf_ipversion>\d+)/(?P<sf_network>\w+)/(?P<sf_iexact>\d+)/(?P<sf_acl>\d+)[/]?$', 'search_list',
        name='vlan.search.list',),
    url('^vlan/find/(?P<id_vlan>\d+)[/]?$', 'ajax_list_vlans',
        name='vlan.list.ajax',),
    url('^vlan/find/(?P<id_vlan>\d+)/(?P<sf_number>\d+)/(?P<sf_name>[\w\-\s]+)/(?P<sf_environment>\d+)/(?P<sf_nettype>\d+)/(?P<sf_subnet>\d+)/(?P<sf_ipversion>\d+)/(?P<sf_network>\w+)/(?P<sf_iexact>\d+)/(?P<sf_acl>\d+)[/]?$', 'ajax_list_vlans',
        name='vlan.list.ajax',),
    ...
    url('^vlan/edit/(?P<id_vlan>\d+)/(?P<sf_number>\d+)/(?P<sf_name>[\w\-\s]+)/(?P<sf_environment>\d+)/(?P<sf_nettype>\d+)/(?P<sf_subnet>\d+)/(?P<sf_ipversion>\d+)/(?P<sf_network>\w+)/(?P<sf_iexact>\d+)/(?P<sf_acl>\d+)[/]?$',
        'vlan_edit', name='vlan.edit.by.id',),
    url('^vlan/delete[/]?$',
        'delete_all', name='vlan.delete',),
    url('^vlan/delete/(?P<sf_number>\d+)/(?P<sf_name>[\w\-\s]+)/(?P<sf_environment>\d+)/(?P<sf_nettype>\d+)/(?P<sf_subnet>\d+)/(?P<sf_ipversion>\d+)/(?P<sf_network>\w+)/(?P<sf_iexact>\d+)/(?P<sf_acl>\d+)[/]?$',
        'delete_all', name='vlan.delete',),
    url('^vlan/delete/network/(?P<id_vlan>\d+)/(?P<sf_number>\d+)/(?P<sf_name>[\w\-\s]+)/(?P<sf_environment>\d+)/(?P<sf_nettype>\d+)/(?P<sf_subnet>\d+)/(?P<sf_ipversion>\d+)/(?P<sf_network>\w+)/(?P<sf_iexact>\d+)/(?P<sf_acl>\d+)[/]?$',
        'delete_all_network', name='vlan.network.delete',),
    url('^vlan/create/(?P<id_vlan>\d+)[/]?$',
        'create', name='vlan.create'),
    url('^vlan/create/(?P<id_vlan>\d+)/(?P<sf_number>\d+)/(?P<sf_name>[\w\-\s]+)/(?P<sf_environment>\d+)/(?P<sf_nettype>\d+)/(?P<sf_subnet>\d+)/(?P<sf_ipversion>\d+)/(?P<sf_network>\w+)/(?P<sf_iexact>\d+)/(?P<sf_acl>\d+)[/]?$',
        'create', name='vlan.create'),
    url('^vlan/create/network/(?P<id_vlan>\d+)[/]?$',
        'create_network', name='vlan.create.network'),
    url('^vlan/create/network/(?P<id_vlan>\d+)/(?P<sf_number>\d+)/(?P<sf_name>[\w\-\s]+)/(?P<sf_environment>\d+)/(?P<sf_nettype>\d+)/(?P<sf_subnet>\d+)/(?P<sf_ipversion>\d+)/(?P<sf_network>\w+)/(?P<sf_iexact>\d+)/(?P<sf_acl>\d+)[/]?$',
        'create_network', name='vlan.create.network'),
    url('^vlan/remove/network/(?P<id_vlan>\d+)[/]?$',
        'remove_network', name='vlan.remove.network'),
    url('^vlan/remove/network/(?P<id_vlan>\d+)/(?P<sf_number>\d+)/(?P<sf_name>[\w\-\s]+)/(?P<sf_environment>\d+)/(?P<sf_nettype>\d+)/(?P<sf_subnet>\d+)/(?P<sf_ipversion>\d+)/(?P<sf_network>\w+)/(?P<sf_iexact>\d+)/(?P<sf_acl>\d+)[/]?$',
        'remove_network', name='vlan.remove.network'),
...
urlpatterns += patterns(
    ...
    url('^network/edit/rede_ipv4/(?P<id_net>\d+)/(?P<id_vlan>\d+)/(?P<sf_number>\d+)/(?P<sf_name>[\w\-\s]+)/(?P<sf_environment>\d+)/(?P<sf_nettype>\d+)/(?P<sf_subnet>\d+)/(?P<sf_ipversion>\d+)/(?P<sf_network>\w+)/(?P<sf_iexact>\d+)/(?P<sf_acl>\d+)[/]?$',
        'edit_network4_form', name='network.edit.by.id.rede.ipv4',),
    url('^network/edit/rede_ipv6/(?P<id_net>\d+)[/]?$',
        'edit_network6_form', name='network.edit.by.id.rede.ipv6',),
    url('^network/edit/rede_ipv6/(?P<id_net>\d+)/(?P<id_vlan>\d+)/(?P<sf_number>\d+)/(?P<sf_name>[\w\-\s]+)/(?P<sf_environment>\d+)/(?P<sf_nettype>\d+)/(?P<sf_subnet>\d+)/(?P<sf_ipversion>\d+)/(?P<sf_network>\w+)/(?P<sf_iexact>\d+)/(?P<sf_acl>\d+)[/]?$',
        'edit_network6_form', name='network.edit.by.id.rede.ipv6',),
    url('^network/form/(?P<id_vlan>\d+)[/]?$',
        'vlan_add_network_form', name='network.form.vlan',),
    url('^network/form/(?P<id_vlan>\d+)/(?P<sf_number>\d+)/(?P<sf_name>[\w\-\s]+)/(?P<sf_environment>\d+)/(?P<sf_nettype>\d+)/(?P<sf_subnet>\d+)/(?P<sf_ipversion>\d+)/(?P<sf_network>\w+)/(?P<sf_iexact>\d+)/(?P<sf_acl>\d+)[/]?$',
        'vlan_add_network_form', name='network.form.vlan',),
    ...
    url('^network/get/ip4/(?P<id_net>\d+)/(?P<id_vlan>\d+)/(?P<sf_number>\d+)/(?P<sf_name>[\w\-\s]+)/(?P<sf_environment>\d+)/(?P<sf_nettype>\d+)/(?P<sf_subnet>\d+)/(?P<sf_ipversion>\d+)/(?P<sf_network>\w+)/(?P<sf_iexact>\d+)/(?P<sf_acl>\d+)[/]?$',
        'list_netip4_by_id', name='network.ip4.list.by.id',),
    url('^network/get/ip6/(?P<id_net>\d+)[/]?$',
        'list_netip6_by_id', name='network.ip6.list.by.id',),
    url('^network/get/ip6/(?P<id_net>\d+)/(?P<id_vlan>\d+)/(?P<sf_number>\d+)/(?P<sf_name>[\w\-\s]+)/(?P<sf_environment>\d+)/(?P<sf_nettype>\d+)/(?P<sf_subnet>\d+)/(?P<sf_ipversion>\d+)/(?P<sf_network>\w+)/(?P<sf_iexact>\d+)/(?P<sf_acl>\d+)[/]?$',
        'list_netip6_by_id', name='network.ip6.list.by.id',),
    url('^network/ip4/(?P<id_net>\d+)[/]?$',
        'insert_ip4', name="network.insert.ip4",),
    url('^network/ip4/(?P<id_net>\d+)/(?P<id_vlan>\d+)/(?P<sf_number>\d+)/(?P<sf_name>[\w\-\s]+)/(?P<sf_environment>\d+)/(?P<sf_nettype>\d+)/(?P<sf_subnet>\d+)/(?P<sf_ipversion>\d+)/(?P<sf_network>\w+)/(?P<sf_iexact>\d+)/(?P<sf_acl>\d+)[/]?$',
        'insert_ip4', name="network.insert.ip4",),
    url('^network/ip6/(?P<id_net>\d+)[/]?$',
        'insert_ip6', name="network.insert.ip6",),
    url('^network/ip6/(?P<id_net>\d+)/(?P<id_vlan>\d+)/(?P<sf_number>\d+)/(?P<sf_name>[\w\-\s]+)/(?P<sf_environment>\d+)/(?P<sf_nettype>\d+)/(?P<sf_subnet>\d+)/(?P<sf_ipversion>\d+)/(?P<sf_network>\w+)/(?P<sf_iexact>\d+)/(?P<sf_acl>\d+)[/]?$',
        'insert_ip6', name="network.insert.ip6",),
    url('^network/edit/ip4/(?P<id_net>\d+)/(?P<id_ip4>\d+)[/]?$',
        'edit_ip4', name='network.edit.ip4',),
    url('^network/edit/ip4/(?P<id_net>\d+)/(?P<id_ip4>\d+)/(?P<id_vlan>\d+)/(?P<sf_number>\d+)/(?P<sf_name>[\w\-\s]+)/(?P<sf_environment>\d+)/(?P<sf_nettype>\d+)/(?P<sf_subnet>\d+)/(?P<sf_ipversion>\d+)/(?P<sf_network>\w+)/(?P<sf_iexact>\d+)/(?P<sf_acl>\d+)[/]?$',
        'edit_ip4', name='network.edit.ip4',),
    url('^network/edit/ip6/(?P<id_net>\d+)/(?P<id_ip6>\d+)[/]?$',
        'edit_ip6', name='network.edit.ip6',),
    url('^network/edit/ip6/(?P<id_net>\d+)/(?P<id_ip6>\d+)/(?P<id_vlan>\d+)/(?P<sf_number>\d+)/(?P<sf_name>[\w\-\s]+)/(?P<sf_environment>\d+)/(?P<sf_nettype>\d+)/(?P<sf_subnet>\d+)/(?P<sf_ipversion>\d+)/(?P<sf_network>\w+)/(?P<sf_iexact>\d+)/(?P<sf_acl>\d+)[/]?$',
        'edit_ip6', name='network.edit.ip6',),
    url('^network/delete/(?P<id_net>\d+)/ip4[/]?$',
        'delete_ip4', name='network.delete.ip4',),
    url('^network/delete/(?P<id_net>\d+)/ip4/(?P<id_vlan>\d+)/(?P<sf_number>\d+)/(?P<sf_name>[\w\-\s]+)/(?P<sf_environment>\d+)/(?P<sf_nettype>\d+)/(?P<sf_subnet>\d+)/(?P<sf_ipversion>\d+)/(?P<sf_network>\w+)/(?P<sf_iexact>\d+)/(?P<sf_acl>\d+)[/]?$',
        'delete_ip4', name='network.delete.ip4',),
    ...
    url('^network/assoc/ip4/(?P<id_net>\d+)/(?P<id_ip4>\d+)/(?P<id_vlan>\d+)/(?P<sf_number>\d+)/(?P<sf_name>[\w\-\s]+)/(?P<sf_environment>\d+)/(?P<sf_nettype>\d+)/(?P<sf_subnet>\d+)/(?P<sf_ipversion>\d+)/(?P<sf_network>\w+)/(?P<sf_iexact>\d+)/(?P<sf_acl>\d+)[/]?$',
        'assoc_ip4', name='network.assoc.ip4',),
    url('^network/assoc/ip6/(?P<id_net>\d+)/(?P<id_ip6>\d+)[/]?$',
        'assoc_ip6', name='network.assoc.ip6',),
    url('^network/assoc/ip6/(?P<id_net>\d+)/(?P<id_ip6>\d+)/(?P<id_vlan>\d+)/(?P<sf_number>\d+)/(?P<sf_name>[\w\-\s]+)/(?P<sf_environment>\d+)/(?P<sf_nettype>\d+)/(?P<sf_subnet>\d+)/(?P<sf_ipversion>\d+)/(?P<sf_network>\w+)/(?P<sf_iexact>\d+)/(?P<sf_acl>\d+)[/]?$',
        'assoc_ip6', name='network.assoc.ip6',),
...
urlpatterns += patterns(
    ...
    url('^rack/delete/environment/(?P<fabric_id>\d+)/(?P<rack_id>\d+)[/]?$', 'remove_rack_env', name='rack.env.delete',),
