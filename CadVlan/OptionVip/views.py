        ...
        if form.is_valid():
            ...
            # If all has ben removed
                ...
                messages.add_message(
                    request,
                    messages.SUCCESS,
                    option_vip_messages.get("success_remove"))
...
def add_form(request):
            ...
            if form.is_valid():
                ...
                try:
                    ...
                    messages.add_message(
                        request,
                        messages.SUCCESS,
                        option_vip_messages.get("success_insert"))
    ...
    return render_to_response(
        OPTIONVIP_FORM, {
            'form': form, 'action': action}, context_instance=RequestContext(request))
    ...
    try:
            ...
            if form.is_valid():
                ...
                try:
                    ...
                    messages.add_message(
                        request,
                        messages.SUCCESS,
                        option_vip_messages.get("success_edit"))
                    return redirect('option-vip.list')
        ...
        if option_vip is None:
            messages.add_message(
                request,
                messages.ERROR,
                option_vip_messages.get("invalid_option_vip"))
            return redirect('option-vip.list')
        ...
        # Set Option VIP data
        initial = {
            'id_option': option_vip.get('id'),
            'name_option': option_vip.get('nome_opcao_txt'),
            'type_option': option_vip.get('tipo_opcao')}
...
def option_vip_associate_net4(request, id_net):
    ...
    try:
        ...
        if isinstance(opts_choisen, dict):
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                messages.add_message(
                    request,
                    messages.SUCCESS,
                    option_vip_messages.get("sucess_options"))
            else:
                post = True
                lists['opt_form'] = form
    ...
    try:
        ...
        if int(id_vip) != int(id_vip):
            ...
            messages.add_message(
                request,
                messages.ERROR,
                option_vip_messages.get("vip_not_in_net") %
                (id_vip,
                 id_net))
