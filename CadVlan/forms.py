...
class RemoveForm(EquipForm):
    ids_remove = forms.CharField(widget=forms.HiddenInput(), label='', required=True)
...
class ControlAcessForm(forms.Form):
    token = forms.CharField(widget=forms.HiddenInput(), label='', required=False)

class ConfigForm(EquipForm):
    ids_config = forms.CharField(widget=forms.HiddenInput(), label='', required=True)

class AplicarForm(EquipForm):
    ids_aplicar = forms.CharField(widget=forms.HiddenInput(), label='', required=True)

class AlocarForm(EquipForm):
    ids_alocar = forms.CharField(widget=forms.HiddenInput(), label='', required=True)
