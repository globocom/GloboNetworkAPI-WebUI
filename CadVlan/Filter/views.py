    ...
    try:
        ...
        for filter_ in filter_list['filter']:
            ...
            if filter_.get('equip_types') is not None:
                if isinstance(filter_['equip_types'], dict):
...
@log
@login_required
@has_perm([{"permission": ENVIRONMENT_MANAGEMENT, "write": True},
           {"permission": VLAN_MANAGEMENT, "write": True}])
        ...
        if form.is_valid():
            ...
            # If all has ben removed
                ...
                messages.add_message(
                    request,
                    messages.SUCCESS,
                    filter_messages.get("success_remove"))
        ...
        if request.method == "POST":
            ...
            if form.is_valid():
                ...
                messages.add_message(
                    request,
                    messages.SUCCESS,
                    filter_messages.get("success_insert"))
...
def edit_form(request, id_filter):
    ...
    try:
        ...
        if isinstance(filter_.get('equip_types'), dict):
            filter_['equip_types'] = [filter_['equip_types']]
        ...
        if request.method == "POST":
            ...
            if form.is_valid():
                ...
                messages.add_message(
                    request,
                    messages.SUCCESS,
                    filter_messages.get("success_edit"))
