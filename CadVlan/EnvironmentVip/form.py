...
class EnvironmentVipForm(forms.Form):
    ...
    client = forms.CharField  (label=u'Cliente', min_length=3, max_length=50,  required=True, error_messages=error_messages, widget=forms.TextInput(attrs={'style': "width: 300px"}))
    environment_p44 = forms.CharField  (label=u'Ambiente P44', min_length=3, max_length=50,  required=True, error_messages=error_messages, widget=forms.TextInput(attrs={'style': "width: 300px"}))
