...
class AclForm(forms.Form):
    ...
    acl = forms.CharField(
        ...
        widget=forms.Textarea(
            attrs={
                'style': "width: 800px;height:400px;resize:none;"}))
...
class TemplateForm(forms.Form):
    ...
    content = forms.CharField(
        ...
        widget=forms.Textarea(
            attrs={
                'style': "width: 600px;height:310px;resize:none;"}))
...
class TemplateAddForm(forms.Form):
    ...
    def clean_name_ipv6(self):
        ...
        if self.cleaned_data[
                'name_ipv6'] and ' ' in self.cleaned_data['name_ipv6']:
            raise forms.ValidationError(
                'O nome do template não deve conter espaços')
