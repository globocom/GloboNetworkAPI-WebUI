...
def ajax_list_logs(request):
    try:
        ...
        if request.method == 'GET':
            ...
            search_form = SearchFormLog(usuarios, acoes, funcionalidades, request.GET)
            ...
            logs = client.create_log().find_logs(user_name, first_date, start_time, last_date, end_time, action, functionality, parameter, pag)
